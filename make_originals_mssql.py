...
def populate_originals(in_csv, out_table):
    cur.execute("if not exists (select * from sysobjects where name='"+out_table+"' and xtype='U') create table "+out_table+' (terms varchar(900), sentence varchar(900), max_level INTEGER, ID varchar(900), snippet varchar(900))')
